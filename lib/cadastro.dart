...
class _CadastroState extends State<Cadastro> {
  ...
  Future<void> cadastrarUsuario(String nome, String email, String idade, String senha) async {
  try {
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              cadastrarUsuario(_nameController.text, _emailController.text, _ageController.text, _passwordController.text);
                            },
